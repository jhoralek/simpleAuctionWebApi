...
export const USER_CHANGE_CURRENT_VALIDATE_USER = 'USER_CHANGE_CURRENT_VALIDATE_USER';
export const USER_CHANGE_CURRENT_VALIDATE_EMAIL = 'USER_CHANGE_CURRENT_VALIDATE_EMAIL';
export const USER_CHANGE_USERS_CURRENT_AUCTIONS = 'USER_CHANGE_USERS_CURRENT_AUCTIONS';
export const USER_CHANGE_USERS_ENDED_AUCTIONS = 'USER_CHANGE_USERS_ENDED_AUCTIONS';
...
export const AUCTION_DELETE_RECORD_FROM_LIST = 'AUCTION_DELETE_RECORD_FROM_LIST';
